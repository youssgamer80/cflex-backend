...
@Slf4j
@Component
@ServerEndpoint(value = "/webSocketVehicule", encoders = MessageEncoder.class, decoders = MessageDecoder.class)
public class SocketVehicule {
    ...
    public static Set<SocketVehicule> listeners = new CopyOnWriteArraySet<>();
    ...
    public static void broadcastVehicule(String message) {
        Vehicule vehicule;
        ...
        for (SocketVehicule listener : listeners) {
