...
@Slf4j
@Component
@ServerEndpoint(value = "/webSocketCouloir", encoders = MessageEncoder.class, decoders = MessageDecoder.class)
public class SocketCouloir {
    ...
    public static void broadcastCouloir(String message) {
        ...
        for (SocketCouloir listener : listeners) {
            ...
            couloirController.createCouloir(couloir);
        }
        saveCouloirinMongo(couloir);
    ...
    public static ResponseEntity<Couloir> saveCouloirinMongo(Couloir couloir) {
