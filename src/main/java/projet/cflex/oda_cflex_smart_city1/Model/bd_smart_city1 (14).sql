...
--
-- Hôte : localhost:8889
-- Généré le : lun. 16 mai 2022 à 15:22
...
ALTER TABLE `demande`
  ...
  ADD KEY `demande-zone` (`id_zone_fk`);
...
ALTER TABLE `demander_itineraire`
  ADD PRIMARY KEY (`id`),
  ADD KEY `demander-itineraire-ibfk` (`id_client_fk`),
...
ALTER TABLE `emprunter`
  ...
  ADD KEY `emprunter_ibfk3` (`id_client_fk`);
...
ALTER TABLE `stationner`
  ...
  ADD KEY `garer_ibfk3` (`id_client_fk`);
