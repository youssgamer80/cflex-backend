...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 14 mai 2022 à 23:21
...
CREATE TABLE IF NOT EXISTS `demande` (
  ...
  `statut` tinyint(1) NOT NULL,
  `id_type_vehicule_fk` int(10) UNSIGNED NOT NULL,
  `id_zone` int(10) UNSIGNED NOT NULL,
  `id_type_transport_fk` int(10) UNSIGNED NOT NULL,
  `immatriculation` varchar(255) NOT NULL,
  `marque` int(255) NOT NULL,
  `model` varchar(255) NOT NULL,
  `nb_place` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `proprietaire-demande` (`id_proprietaire_fk`),
  KEY `demande-vehicule` (`id_type_vehicule_fk`),
  KEY `demande-zone` (`id_zone`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `demande`
  ADD CONSTRAINT `demande-vehicule` FOREIGN KEY (`id_type_vehicule_fk`) REFERENCES `vehicule` (`id`),
  ADD CONSTRAINT `demande-zone` FOREIGN KEY (`id_zone`) REFERENCES `zone` (`id`),
